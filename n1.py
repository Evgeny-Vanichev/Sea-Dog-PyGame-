...
print(",".join(jsn["response"]["GeoObjectCollection"]["featureMember"][0]["GeoObject"]['Point']['pos'].split()))

map_request = "http://static-maps.yandex.ru/1.x/?ll=37.622513,55.75322&spn=0.1,0.15&l=map&kind=stadium"
